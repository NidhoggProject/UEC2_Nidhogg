...
#
# Generated by Vivado on Fri Sep 18 01:09:06 +0200 2020
...
# Script info
echo -e "clk.sh - Script generated by export_simulation (Vivado v2017.3 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk xil_defaultlib.clk xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk -key {Behavioral:sim_1:Functional:clk} -tclbatch cmd.tcl -log simulate.log
}
