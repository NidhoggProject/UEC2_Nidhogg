...
HD_PWD='C:/__Programowanie__/Vivado/PrzemyslawKurzak/UEC_2_Project/kurzak_keyboard/kurzak_keyboard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nidhogg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nidhogg.tcl -notrace
