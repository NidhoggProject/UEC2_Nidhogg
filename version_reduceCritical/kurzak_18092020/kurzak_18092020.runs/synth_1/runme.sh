...
HD_PWD='C:/__Programowanie__/Vivado/PrzemyslawKurzak/UEC_2_Project/kurzak_18092020/kurzak_18092020.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nidhogg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nidhogg.tcl
